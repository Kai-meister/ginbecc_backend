...
public final class ExcelUtils {
    ...
    public static byte[] documents(
        ...
        try (XSSFWorkbook wb = new XSSFWorkbook()) {
            ...
            XSSFSheet sh = wb.createSheet("របាយការណ៍ឯកសារ");
            Styles s = new Styles(wb);
            int cols = 9;
            int r = 0;
            ...
            r = colHeaders(sh, s, r, new String[]{
                    "ល.រ", "លេខឯកសារ",
                    "ឈ្មោះឯកសារ", "ប្រភេទឯកសារ",
                    "មន្ត្រី", "នាយកដ្ឋាន",
                    "ថ្ងៃផុតកំណត់", "ស្ថានភាព",
                    "កាលបរិច្ឆេទបង្កើត"
            });
            ...
            throw new RuntimeException(
                    "មានបញ្ហាក្នុងការបង្កើតរបាយការណ៍ឯកសារ: "
                            + e.getMessage());
        }
    }
    ...
    public static byte[] approvals(
        ...
        try (XSSFWorkbook wb = new XSSFWorkbook()) {
            ...
            XSSFSheet sh =
                    wb.createSheet("របាយការណ៍ការអនុម័ត");
            Styles s = new Styles(wb);
            int cols = 8;
            int r = 0;
            ...
            throw new RuntimeException(
                    "មានបញ្ហាក្នុងការបង្កើតរបាយការណ៍ការអនុម័ត "
                            + e.getMessage());
        }
    }
