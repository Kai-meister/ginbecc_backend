...
//        if (permissionRepository.count() > 0) return;
        String[][] perms = {
                ...
                {"OFFICE_VIEW",            "OFFICER", "មើលផ្នែកការិយាល័យ",            "អនុញ្ញាតឱ្យមើលបញ្ជីផ្នែកការិយាល័យទាំងអស់"},
                {"OFFICE_MANAGE",          "OFFICER", "គ្រប់គ្រងផ្នែកការិយាល័យ",         "អនុញ្ញាតឱ្យគ្រប់គ្រង បន្ថែម និងកែប្រែផ្នែកការិយាល័យ"},
