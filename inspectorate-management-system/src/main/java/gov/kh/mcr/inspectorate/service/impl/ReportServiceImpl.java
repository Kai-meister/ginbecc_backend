...
public class ReportServiceImpl
    ...
    @Override
    public List<MeetingMinuteReportResponse> previewMeetingMinutes(int month, int year, Long meetingId) {
    ...
    previewAnnouncements(
        ...
        // Fix — convert String → Priority Enum
...
//    }
    ...
    private String actionKh(String action) {
        ...
        return switch (action.toUpperCase()) {
            case "CREATE"          -> "បង្កើត";
            case "UPDATE"          -> "កែសម្រួល";
            case "DELETE"          -> "លុប";
            case "LOGIN"           -> "ចូលប្រព័ន្ធ";
            case "LOGOUT"          -> "ចេញពីប្រព័ន្ធ";
            case "RESET_PASSWORD"  -> "កំណត់លេខសម្ងាត់ឡើងវិញ";
            case "CHANGE_PASSWORD" -> "ប្ដូរលេខសម្ងាត់";
            default -> action;
        };
    }
